...
void ui_event_run_button(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_CLICKED) {
        ...
        /* save Interface type (stored as ASCII digit: '0'=JTAG, '1'=SWD) */
        ...
        char interface = (char)(selected_index + '0');
        ...
        /* save debug_level (stored as ASCII digit: '1'=level0 … base is '1' not '0') */
        selected_index = lv_dropdown_get_selected(g_ui_debug_level_dropdown);
        char debug_level = (char)(selected_index + '1');
